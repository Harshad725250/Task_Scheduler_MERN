        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              The ultimate productivity tool to manage your tasks, set
              priorities, and achieve your goals. Join thousands of users who
              have transformed their workflow.
            </p>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="feature-description">
                ...
                interface. Set deadlines, add notes, and track progress
                effortlessly.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Monitor how much time you spend on each task. Get insights into
                your productivity patterns and optimize your workflow.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Visualize your productivity with detailed charts and reports.
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Share tasks with team members, assign responsibilities, and
                collaborate seamlessly on projects of any size.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <p className="cta-subtitle">
              ...
              workflow with TaskScheduler
            </p>
            <div className="cta-buttons">
              {/* Use Link for navigation */}
              <Link to="/register" className="cta-button primary large">
                {" "}
                {/* onNavigate("signup") -> to="/register" */}
                Start Free Trial
                <span className="button-arrow">→</span>
              </Link>
              {/* Use Link for navigation */}
